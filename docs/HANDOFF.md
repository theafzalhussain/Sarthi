...
> automation, aur **360 tests jo `python run_tests.py` se chalte hain.**
...
### ✅ AB ASLI TEST SUITE HAI — 360 tests
...
python run_tests.py           # PEHLE YE — 360 tests, 5 second
...
| **Tests** | **360 pass** — `python run_tests.py` |
...
1. `python run_tests.py` chala — 360 pass hone chahiye. Kuch fail ho to
