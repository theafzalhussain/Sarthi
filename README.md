...
415 tests, koi extra install nahi chahiye. Sab pass hone chahiye.
...
run_tests.py        415 tests — koi install nahi chahiye
...
```bash
python run_tests.py              # sab — 415 tests, 0.1 second
