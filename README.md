...
386 tests, koi extra install nahi chahiye. Sab pass hone chahiye.
...
run_tests.py        386 tests — koi install nahi chahiye
...
```bash
python run_tests.py              # sab — 386 tests, 0.1 second
