...
462 tests, koi extra install nahi chahiye. Sab pass hone chahiye.
...
- 40 tools, safety layer + **voice confirmations**
...
run_tests.py        462 tests — koi install nahi chahiye
...
```bash
python run_tests.py              # sab — 462 tests, 0.1 second
